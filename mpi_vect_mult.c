...
int main(void) {
    ...
    Print_vector(local_scalar_mult1, local_n, n, "product of first vector with the scalar is", my_rank, comm);
    Print_vector(local_scalar_mult2, local_n, n, "product of second vector with the scalar is", my_rank, comm);
